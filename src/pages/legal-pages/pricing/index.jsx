...
import { getPricings, deletePricing } from "../../../apis/pricing";
  ...
  const deleteHandler = (_id) => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        deletePricing(_id)
          .then((res) => {
            setPricingData(pricingData.filter((item) => item._id != _id));
          ...
          <div className="content-page-header content-page-headersplit mb-0">
            ...
            <div className="list-btn">
              <ul>
                ...
                <li>
                  <Link className="btn btn-primary" to="/pricing/new">
                    <i className="fa fa-plus me-2"></i>Add Pricing{" "}
                  </Link>
                </li>
              </ul>
            </div>
