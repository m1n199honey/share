...
const Index = () => {
  ...
  const [activeCategory, setActiveCategory] = React.useState(-1); // default Job
  ...
  // on changing params, set active category
  React.useEffect(() => {
    const index = paramsType.indexOf(params?.crmType);
          ...
          <div className="content">
            <div className="dashboard-content">
              <div className="container">
                ...
                {
                  activeCategory !== 5 && (0 <= activeCategory && activeCategory <= 12) ? (<> {/* show if category is not Job */}
                    <div className="">
                      <ul className="dashborad-menus">
